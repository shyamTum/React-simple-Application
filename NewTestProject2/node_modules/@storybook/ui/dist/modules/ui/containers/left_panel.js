...
var mapper = exports.mapper = function mapper(state, props, _ref) {
  ...
  var filteredStories = filters.storyFilter(stories, storyFilter, selectedKind, sortStoriesByKind);

  var storiesHierarchy = (0, _hierarchy.createHierarchy)(filteredStories, hierarchySeparator);
  var selectedHierarchy = (0, _hierarchy.resolveStoryHierarchy)(selectedKind, hierarchySeparator);
